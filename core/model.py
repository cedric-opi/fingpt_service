...
def load_model_and_tokenizer():
    ...
    if quant_config:
        ...
        model_kwargs = {
            "low_cpu_mem_usage": True,
            "trust_remote_code": True,
            "use_cache": True,  # ADD THIS - enables KV cache for faster generation
            "attn_implementation": "sdpa",  # ADD THIS - use optimized attention
        }
    else:
...
def generate_forecast(
    ...
    inputs = _tokenizer(
        ...
        return_tensors="pt",
        truncation=True,
        max_length=1024,  # Llama context window
        padding=False
    )
